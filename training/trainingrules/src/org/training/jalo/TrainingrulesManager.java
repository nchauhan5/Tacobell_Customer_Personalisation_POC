...
/**
 * This is the extension manager of the Trainingrules extension.
 */
public class TrainingrulesManager extends GeneratedTrainingrulesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TrainingrulesManager.class);
	 ...
	 */
	public static TrainingrulesManager getInstance()
	{
		return (TrainingrulesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TrainingrulesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingrulesManager() // NOPMD 
	{
		LOG.debug("constructor of TrainingrulesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of TrainingrulesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of TrainingrulesManager called, current tenant: {}", getTenant().getTenantID());
	}
