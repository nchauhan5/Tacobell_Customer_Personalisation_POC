...
public class DefaultTrainingrulesService implements TrainingrulesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrainingrulesService.class);
	...
	{
		return DefaultTrainingrulesService.class.getResourceAsStream("/trainingrules/sap-hybris-platform.png");
	}
