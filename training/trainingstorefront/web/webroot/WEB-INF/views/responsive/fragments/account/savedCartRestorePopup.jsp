...
<c:url var="restoreSavedCartPostUrl"
       value="/my-account/saved-carts/${commerceSaveCartResultData.savedCartData.code}/restore"/>
...
<div id="popup_confirm_savedcart_restore" class="savedcart_restore_confirm_modal js-savedcart_restore_confirm_modal">
    ...
    <div class="modal-details row">
        ...
        <span class="col-xs-6"><b>${commerceSaveCartResultData.savedCartData.name}</b></span>
        <span class="col-xs-6"><spring:theme code="text.account.savedcart.cart.id"/>:</span>
        <span class="col-xs-6"><b>${commerceSaveCartResultData.savedCartData.code}</b></span>
