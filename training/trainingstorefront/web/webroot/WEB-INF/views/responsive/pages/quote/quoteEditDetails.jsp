        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="quote__comments__header">
                    <button class="quote__comments--toggle" type="button" data-toggle="collapse" data-target="#comments__collapse" aria-expanded="false" aria-controls="comments__collapse">

                    </button>
                    <span class="quote__comments__header--title"><spring:theme code="quote.cart.comments"/></span>
                </div>
                <div class="quote__comments">
                    <div class="collapse in quote__comments--wrapper" id="comments__collapse">
