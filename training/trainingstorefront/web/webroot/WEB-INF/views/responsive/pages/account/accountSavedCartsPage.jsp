...
<c:if test="${not empty searchPageData.results}">
    <div class="account-section-content">
        ...
        <div class="account-overview-table saved__carts__overview--table">
            ...
            <table class="responsive-table">
                ...
                <c:forEach items="${searchPageData.results}" var="savedCart" varStatus="loop">
                    ...
                    <tr id="row-${loop.index}" class="responsive-table-item"> 		
						...
						<td class="responsive-table-cell less-padding remove-item-column">
			...
			<div class="js-uploading-saved-carts-update" data-id-row-mapping="${cartIdRowMapping}" data-refresh-cart="${fn:escapeXml(refreshSavedCart)}" 
