 ...
 */
@IntegrationTest
public class DefaultSmarteditpersonalizationservicesServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "smarteditpersonalizationservicesPlatformLogo";

		// when
		final String logoUrl = smarteditpersonalizationservicesService.getHybrisLogoUrl(logoCode);
