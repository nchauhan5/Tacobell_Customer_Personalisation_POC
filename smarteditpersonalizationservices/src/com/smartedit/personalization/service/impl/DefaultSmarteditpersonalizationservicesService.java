 ...
 */
package com.smartedit.personalization.service.impl;
...
public class DefaultSmarteditpersonalizationservicesService implements SmarteditpersonalizationservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSmarteditpersonalizationservicesService.class);
	...
	{
		return DefaultSmarteditpersonalizationservicesService.class.getResourceAsStream("/smarteditpersonalizationservices/sap-hybris-platform.png");
	}
