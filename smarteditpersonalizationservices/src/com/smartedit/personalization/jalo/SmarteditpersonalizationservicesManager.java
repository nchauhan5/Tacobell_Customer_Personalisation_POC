 ...
 */
package com.smartedit.personalization.jalo;
...
/**
 * This is the extension manager of the Smarteditpersonalizationservices extension.
 */
public class SmarteditpersonalizationservicesManager extends GeneratedSmarteditpersonalizationservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SmarteditpersonalizationservicesManager.class);
	 ...
	 */
	public static SmarteditpersonalizationservicesManager getInstance()
	{
		return (SmarteditpersonalizationservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SmarteditpersonalizationservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SmarteditpersonalizationservicesManager() // NOPMD 
	{
		LOG.debug("constructor of SmarteditpersonalizationservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SmarteditpersonalizationservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SmarteditpersonalizationservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
